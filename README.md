...
- **Shows agent panes at a glance**: a second status row displays bracketed panes with red/yellow/green dots (unseen-stopped, working, seen-stopped) and configurable fields. It does not replace your existing first-row status format.
